...
def train_single_layer(base_model, train_loader, val_loader, target, lr=0.001,
...
def main():
    ...
    inst_detect_model = train_single_layer(
        base_model, train_loader, val_loader, TARGET_INST)
    ...
    note_detect_model = train_single_layer(
        base_model, train_loader, val_loader, TARGET_NOTES, lr=1e-2)
